 ...
 */
public class Category_Book1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_book1);
    ...
    public void onClick(View v){
        ...
        switch (id){
            ...
            case R.id.btn_010:
                intent = new Intent(getBaseContext(), Category_ListView.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","010");
                startActivity(intent);
                break;
            ...
            case R.id.btn_011:
                intent = new Intent(getBaseContext(), Category_ListView.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","011");
                startActivity(intent);
                break;
            ...
            case R.id.btn_012:
                intent = new Intent(getBaseContext(), Category_ListView.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","012");
                startActivity(intent);
                break;
            ...
            case R.id.btn_013:
                intent = new Intent(getBaseContext(), Category_ListView.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","013");
                startActivity(intent);
                break;
