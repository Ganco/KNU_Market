 ...
 */
public class Category_Book extends Activity{
    ...
    public void onClick(View v){
        ...
        switch (id){
            ...
            case R.id.btn_099:
                ...
                intent.putExtra("category_no","099");
                startActivity(intent);
                break;

            case R.id.btn_009:
                intent = new Intent(getBaseContext(), Category_Book0.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
            ...
            case R.id.btn_019:
                intent = new Intent(getBaseContext(), Category_Book1.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","019");
                startActivity(intent);
                break;

            case R.id.btn_029:
                intent = new Intent(getBaseContext(), Category_Book2.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
