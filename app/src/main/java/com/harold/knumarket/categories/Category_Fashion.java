 ...
 */
public class Category_Fashion extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_fashion);
    ...
    public void onClick(View v){
        ...
        switch (id){
            ...
            case R.id.btn_299:
                ...
                intent.putExtra("category_no","299");
            ...
            case R.id.btn_210:
                intent = new Intent(getBaseContext(), Category_ListView.class);
                //intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("category_no","210");
                startActivity(intent);
                break;
