...
public class Post_DTO {
        ...
        Post_DTO(String client_id, String category_id, String product_name, String product_price, String product_detail, ArrayList<String> post_keyword, ArrayList<File> imgFiles) {
