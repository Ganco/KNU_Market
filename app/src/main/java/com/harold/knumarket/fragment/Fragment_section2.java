...
public class Fragment_section2 extends Fragment {
    ...
    private static final String TAG = "Fragment_section2";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(netStat){//WIFI나 데이터네트워크 사용 가능
            ...
            ((LinearLayout)getActivity().findViewById(R.id.f_sec2_linear_horiz)).addView(refresh);
        }
        //작업 부분
    ...
    public void updateView(JSONArray array){
        ...
        int screenWidth = metrics.widthPixels;
            ...
            for (int i = 1; i <= line_num; i++) {
                ...
                LinearLayout linearLayout_vertic = (LinearLayout) getActivity().findViewById(R.id.f_sec2_linear_vertic);
